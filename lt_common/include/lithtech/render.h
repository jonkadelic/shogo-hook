...
static_assert(offsetof(RenderStruct_t, m_DontClearMarker) == 0x00d8);
static_assert(offsetof(RenderStruct_t, m_pTexture) == 0x00dc);
static_assert(offsetof(RenderStruct_t, m_pPanningSkyInfo) == 0x00e0);
