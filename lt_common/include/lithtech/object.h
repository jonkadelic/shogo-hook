...
static_assert(offsetof(PolyGrid_t, base) == 0x00);
static_assert(offsetof(PolyGrid_t, m_pData) == 0x128);
static_assert(offsetof(PolyGrid_t, m_pIndices) == 0x12c);
static_assert(offsetof(PolyGrid_t, m_pSprite) == 0x130);
static_assert(offsetof(PolyGrid_t, m_SpriteTracker) == 0x134);
static_assert(offsetof(PolyGrid_t, m_pEnvMap) == 0x148);
static_assert(offsetof(PolyGrid_t, m_xPan) == 0x14c);
static_assert(offsetof(PolyGrid_t, m_yPan) == 0x150);
static_assert(offsetof(PolyGrid_t, m_xScale) == 0x154);
static_assert(offsetof(PolyGrid_t, m_yScale) == 0x158);
static_assert(offsetof(PolyGrid_t, m_nTris) == 0x15c);
static_assert(offsetof(PolyGrid_t, m_nIndices) == 0x160);
static_assert(offsetof(PolyGrid_t, m_LeafLinks) == 0x164);
static_assert(offsetof(PolyGrid_t, m_Width) == 0x170);
static_assert(offsetof(PolyGrid_t, m_Height) == 0x174);
static_assert(offsetof(PolyGrid_t, m_ColorTable) == 0x178);
